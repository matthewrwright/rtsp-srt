...
exec gst-launch-1.0 -v rtspsrc ${RTSP_USER_ID} ${RTSP_USER_PW} location=${RTSP_URL} ! rtph264depay ! h264parse ! mpegtsmux ! rndbuffersize max=1316 min=1316 ! srtserversink latency=100 uri=srt://:${SRT_PORT}/ ${SRT_PASSPHRASE} ${SRT_KEY_LENGTH}
