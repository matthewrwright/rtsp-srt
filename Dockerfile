...
RUN DEBIAN_FRONTEND=noninteractive apt-get install -y srt-tools  libsrt-openssl-dev git gtk-doc-tools libgstreamer-plugins-base1.0-dev libssl-dev

RUN DEBIAN_FRONTEND=noninteractive apt-get install -y autoconf automake build-essential autopoint libtool
